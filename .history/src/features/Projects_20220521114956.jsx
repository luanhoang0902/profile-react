...
const detail = [
  {
    id: 1,
    name: "Clone Nike.com",
    feature: ["Trang chủ", "Validate", "Trang danh sách sản phẩm"],
...
function Projects(props) {
  ...
  if(id === 1){controlLeft.current.style.opacity = "0"}else{controlLeft.current.style.opacity = "1"};
  // if(id === 4){controlRight.current.style.opacity = "0"}else{controlRight.current.style.opacity = "1"};
