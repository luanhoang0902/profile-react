...
const detail = [
  ...
  },
  {
    id: 3,
    name: "Tic toc toe",
    feature: ["Người nào điền được 3 ô nối nhau sẽ win", "Có 3 trường hợp xảy ra: X win, Y win, Hòa", "Khi có người thắng hoặc hòa thì hiện nút Reset game để chơi lại"],
    technology: ["html5", "css3", "javascript","react"],
