    ...
    <div className="projects">
      ...
      <div className="project-list__slider" ref={slider}>
        ...
        <div className="project-list__slider-all">
          <i class="bx bx-chevron-left" onClick={(e) =>{id !== 1 ? setId(id - 1): console.log('ok')}} ref = {controlLeft}></i>
          ...
          <i class="bx bx-chevron-right" onClick={(e) =>{id !== 4 ? setId(id + 1): console.log('ok')}} ref = {controlRight}></i>
        </div>
      </div>
    </div>
  );
