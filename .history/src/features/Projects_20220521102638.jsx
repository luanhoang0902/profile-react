...
const detail = [
  {
    ...
    technology: ["html5", "css3", "javascript", "reactjs", "redux"],
  },
  {
    id: 2,
    name: "hook",
            ...
            <div className="project-list__slider-content-detail">
              ...
              <div>
                <ul>
                  Technology:
                  <li>
                  <i class={`bx bxl-${detail[id - 1].technology[0]}`}></i>
                  {detail[id - 1].technology[0]}
                  </li>
                  <li>
                  <i class={`bx bxl-${detail[id - 1].technology[1]}`} ></i>
                  {detail[id - 1].technology[1]}
                  </li>
                  <li>
                  <i class={`bx bxl-${detail[id - 1].technology[2]}`} ></i>
                  {detail[id - 1].technology[2]}
                  </li>
                  <li>
                  <i class={`bx bxl-${detail[id - 1].technology[3]}`} ></i>
                  {detail[id - 1].technology[3]}
                  </li>
                </ul>
              </div>
            </div>
