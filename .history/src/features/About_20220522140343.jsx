        ...
        <div className="about">
            ...
            <div className="about-content">
                ...
                <div className="about-content__infomation">
                    ...
                    <p>Hiện tại tôi đang trên con đường trở thành lập trình viên Front End chuyên nghiệp. Mong muốn tìm được một công việc phù hợp để thực hiện ước mơ của mình.</p>
                </div>
            </div>
        </div>
    );
