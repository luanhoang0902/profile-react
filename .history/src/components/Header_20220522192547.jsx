  ...
  return (
    <div className="header" ref={varHeader}>
      <div className="header__content">
        <div className="header__one"><Link to="/" style = {{textDecoration: "none", color: "white"}}>Nual</Link></div>
        <div className="header__two">
          <div>
            <Link to="/Projects" style = {{textDecoration: "none", color: "white"}}>Projects</Link>
          </div>
          <div>
            <Link to="/Technologies" style = {{textDecoration: "none", color: "white"}}>Technologies</Link>
          </div>
          <div>
