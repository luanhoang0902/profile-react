  ...
  return (
    <div className="header" ref={varHeader}>
      <div className="header__content">
        <div className="header__one"><Link to="/" style = {{textDecoration: "none", color:'var(--white)'}}>Nual</Link></div>
        ...
        <div className="header__three">
          <a href="https://www.facebook.com/profile.php?id=100029577947626" target="_blank"> 
            <i class="bx bxl-facebook"></i>
          </a>
          <a href = 'https://github.com/luanhoang0902 ' target="_blank">
