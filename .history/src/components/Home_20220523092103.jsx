      ...
      <div className="home-content">
        ...
        <div className="home-image">
          ...
          <div className="home-image__infomation">
              ...
              <div className="home-image__infomation-button"><a href="CV-HoangVanLuan.pdf" download="proposed_file_name">Download</a></div>
              <form method="get" action="CV-HoangVanLuan.pdf">
              <button  button type="submit" className="home-image__infomation-button">Download!</button>
              </form>
          </div>
        </div>
        </div>
        ...
        <div className="home-infomation">
          ...
          <div className="home-infomation__favorite">
            ...
            <div>
              <u>Ca hát</u>
              <br />
              <audio src="./autotool.m4a" controls style={{height: 20}}></audio>
            </div>
            <div>
              <u>Đọc sách</u>
